...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        debugButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mEmailView.setText("201340922109");
...
//        Log.v("Tag","Load actionbar"+mActionbar);
//        if (mActionbar == null) {
//            return false;
//        }
//
...
//        mActionbar.getCustomView().findViewById(R.id.left_imbt).setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                finish();
//            }
...
//    }
    ...
    /**
     * Attempts to sign in or register the account specified by the logandroid.app.ActionBar mActionbar = getActionBar();in form.
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                // Retrieve com.nongda.jonney.data rows for the device user's 'profile' contact.
